...
import { Search, Filter, RefreshCw, Check, Trash2 } from 'lucide-react';
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            <div className={`p-3 rounded-xl ${theme.primary} text-white`}>
              <Icon size={32} />
            </div>
            <div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-6">
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={fetchTodos}
                disabled={loading}
                className={`px-3 py-2 rounded-macos bg-macos-gray-100 text-macos-gray-600 hover:bg-macos-gray-200 transition-all ${
                  loading ? 'opacity-50' : ''
                }`}
              >
